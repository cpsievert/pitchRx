...
opts_chunk$set(fig.path="figure/", cache.path="cache/", dev="CairoPNG", out.extra='style="display:block; margin: auto"', fig.align="center", warning=FALSE, fig.height=7, fig.width=5)
...
```{r ani2, fig.show="animate", interval=0.01, cache=TRUE, fig.height=28, fig.width=20}
